...
pois_vars <- c("ln_livestock_consumption_kg_per_pcu", "ln_livestock_pcu", "ln_migrant_pop_perc", "ln_tourism_inbound_perc",  "ln_tourism_outbound_perc", "ab_export_perc", "health_expend_perc", "human_consumption_ddd", "english_spoken", "ln_gdp_per_capita")
...
p_zi_lines <- 
  ...
  facet_wrap(var ~ ., scales = "free", drop = FALSE,  ncol = 2, labeller = global_labeller) +
...
p_pois_lines <-  
  ...
  facet_wrap(var ~ ., scales = "free", drop = FALSE,  nrow = 2, labeller = global_labeller) +
