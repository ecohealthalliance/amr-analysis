...
zi_vars <- c("ln_promed_mentions_per_capita", "ln_gdp_per_capita", "ln_population", "english_spoken")
pois_vars <- c("ln_livestock_consumption_kg_per_capita", "ln_migrant_pop_perc", "ln_tourism_inbound_perc",  "ln_tourism_outbound_perc", "ab_export_perc", "health_expend_perc", "human_consumption_ddd", "english_spoken", "ln_promed_mentions_per_capita", "ln_gdp_per_capita")
...
lookup_vars <- c( "health_expend_perc" ="Health Expenditure (% GDP)", 
                  ...
                  "ln_promed_mentions_per_capita" = "PubMed Mentions (per capita; ln scale)")
...
p_zi_ribbon <- 
  ...
  labs(y = "Logisitic Prob of No Response", x = "", main = "Logistic Model (zi)") +
  theme_bw() + 
  theme(strip.text.x = element_text(size = 16), axis.text = element_text(size = 14))
