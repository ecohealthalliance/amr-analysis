...
3) Countries with GDP values within the range of countries that have values for both human and animal antimicrobial consumption, i.e., both consumption values can be imputed (n = `r nrow(data_v3_countries_in_range_gdp)`). The figure below shows the distribution of GDPs for countries in this subset.
```{r gdp, fig.height=2}
