...
3) All countries in the dataset, i.e., full imputation of missing values (n = `r nrow(data_v3_full_impute)`)
...
data_v3_full_impute %>% 
  ...
  vis_miss(show_perc = FALSE, show_perc_col = TRUE)
```
...
labs <- c("1. Countries with values for human AND animal antimicrobial consumption data", "2. Countries with values for human OR animal antimicrobial consumption data", "3. All countries in dataset")
loadd(coefs, coefs_2, coefs_3)
...
map_dat_list <- list(map_data, map_data_2, map_data_3)
raw_dat_list <- list(data_v1_complete_only, data_v2_human_or_animal, data_v3_full_impute)
