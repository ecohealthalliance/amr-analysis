main_formula <- bf(n_amr_events ~ ln_livestock_consumption_kg_per_capita * ln_gdp_per_capita +
...
remove_livestock_formula <- bf(n_amr_events ~ ln_gdp_per_capita +
                                 ln_migrant_pop_per_capita + ln_tourism_inbound_per_capita + #ln_tourism_outbound_per_capita +
                                 ln_ab_export_per_capita + #ab_export_bin + 
                                 health_expend_perc +
                                 human_consumption_ddd + english_spoken +
...
livestock_biomass_included_formula <- bf(n_amr_events ~  ln_livestock_consumption_kg_per_pcu + ln_livestock_pcu + ln_gdp_per_capita +
                                           ln_migrant_pop_per_capita + ln_tourism_inbound_per_capita + #ln_tourism_outbound_per_capita +
                                           ln_ab_export_per_capita + #ab_export_bin + 
                                           health_expend_perc + 
                                           human_consumption_ddd + english_spoken + 
