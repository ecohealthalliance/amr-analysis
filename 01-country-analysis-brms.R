...
country_raw <- read_csv(h("data/country-level-amr.csv")) %>%
  ...
  dplyr::select(-livestock_consumption_kg_per_pcu, -tourism_outbound_per_capita)
...
country_raw <- country_raw %>%
  ...
  mutate_at(vars(gdp_per_capita, migrant_pop_per_capita, population, livestock_consumption_kg_per_capita, tourism_inbound_per_capita, 
  ...
  rename_at(vars("livestock_consumption_kg_per_capita", "migrant_pop_per_capita", "promed_mentions_per_capita", "pubcrawl_per_capita",
                 "gdp_per_capita" , "population", "tourism_inbound_per_capita", "ab_export_per_capita", "ab_import_per_capita", "livestock_pcu"), ~paste0("ln_", .))
